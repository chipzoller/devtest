...
Verify that you can run the built-in web server. It will dramatically shorten your technology cycle if you do. Start it by running the "server" command. If it is successful, you will see output similar to the following:
